            ...
            <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--color-bg-alt)', padding: 'var(--space-xl)' }}>
                <div className="card" style={{ maxWidth: 440, width: '100%', padding: 'var(--space-2xl)' }}>
                    ...
                    <button
                        ...
                        onMouseEnter={(e) => { e.currentTarget.style.background = 'var(--color-bg-alt)'; e.currentTarget.style.borderColor = 'var(--color-accent)'; }}
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-md)', margin: 'var(--space-lg) 0' }}>
                        ...
                        <span style={{ color: 'var(--color-text-muted)', fontSize: '0.85rem' }}>o con email</span>
                        <div style={{ flex: 1, height: 1, background: 'var(--color-border)' }} />
                    </div>
